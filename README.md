...
<head>
    ...
    <style>
        ...
        .header {
            ...
            text-align: center;
            padding: 20px;
            background-color: #4CAF50; /* Random background color */
            color: #fff; /* Font color (non-black) */
            font-family: 'Cursive', sans-serif; /* Stylish font-family */
        }
        ...
        .tile {
            ...
            max-width: 400px; /* Maximum width for each tile */
        }
        ...
        /* Additional style for the FAQ tile at the bottom */
        .faq-tile {
